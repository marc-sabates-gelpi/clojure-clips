...
(let [a (atom {:a [{:b :valb :c :valc}]})]
  (swap! a update-in [:a 0] dissoc :b)
  @a)

(into {} '(["session-id" {:value "session-id-1"}] ["session-id" {:value "session-id-2"}])) ; => {"session-id" {:value "session-id-2"}}

(into {} '(["session-id" {:value "session-id-1"}] ["session-id" {:value "session-id-2"}] ["ring-id" {:value "ring-id"}])) ; => {"session-id" {:value "session-id-2"} "rind-id" {:value "ring-id"}}
